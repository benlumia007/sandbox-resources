...
if [[ ! -d "/srv/www/dashboard/public_html/phpmyadmin" ]]; then
    ...
    wget -q https://files.phpmyadmin.net/phpMyAdmin/5.1.0/phpMyAdmin-5.1.0-all-languages.zip -O phpmyadmin.zip
    unzip -q phpmyadmin.zip -d "/srv/www/dashboard/public_html/phpmyadmin"
    mv phpMyAdmin-5.1.0-all-languages/* "/srv/www/dashboard/public_html/phpmyadmin"
